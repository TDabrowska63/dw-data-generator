...
BULK INSERT dbo.Samochody FROM "C:\Users\TH3V1LPL4Y3R\Desktop\data gen\dw-data-generator\bulks2\cars.bulk" WITH (FIELDTERMINATOR='|') --manually set
BULK INSERT dbo.Uzytkownicy FROM "C:\Users\TH3V1LPL4Y3R\Desktop\data gen\dw-data-generator\bulks2\users.bulk" WITH (FIELDTERMINATOR='|') --manually set
BULK INSERT dbo.Miejsca FROM "C:\Users\TH3V1LPL4Y3R\Desktop\data gen\dw-data-generator\bulks2\places.bulk" WITH (FIELDTERMINATOR='|') --manually set
BULK INSERT dbo.Wypozyczenia FROM "C:\Users\TH3V1LPL4Y3R\Desktop\data gen\dw-data-generator\bulks2\rents.bulk" WITH (FIELDTERMINATOR='|') --manually set
BULK INSERT dbo.OcenyPrzejazdu FROM "C:\Users\TH3V1LPL4Y3R\Desktop\data gen\dw-data-generator\bulks2\opinions.bulk" WITH (FIELDTERMINATOR='|') --manually set
